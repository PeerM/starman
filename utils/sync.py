...
movie_name = 'movies/5_1-1_without-shortcut.fm2'
...
# with open(movie_name[:-3] + "info") as info_file:
#     info_file.write("total reward: {}".format(sum(rewards)))
plt.close()
